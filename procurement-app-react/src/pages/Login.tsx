      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <Paper elevation={0} sx={{ p: 4, borderRadius: 4, border: '1px solid #e8edf3', width: 400, maxWidth: '100%' }}>
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="h2" sx={{ fontSize: 22, fontWeight: 800 }}>Welcome back</Typography>
            <Typography variant="body2" sx={{ mt: 0.5 }}>Sign in to ProcurementAI</Typography>
          </Box>
          ...
          <Typography variant="body2" sx={{ textAlign: 'center' }}>
            ...
            <Link to="/signup" style={{ color: '#2E75B6', fontWeight: 600 }}>Sign up</Link>
          </Typography>
        </Paper>
      </motion.div>
    </Box>
